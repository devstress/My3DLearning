...
- Testing conventions: `[SetUp]`, `Assert.That`, 1,400 unit tests
...
```
               ...
               │   1,400 tests       │  (fastest, most numerous)
               └──────────────────────┘
```

## Unit Tests (NUnit 4.4 + NSubstitute)

The foundation with 1,400 tests covering all core logic:
...
```
tests/
├── UnitTests/              # 1,400 fast, isolated tests
