...
/// to <see cref="ITraceAnalyzer"/> (backed by Ollama) for trace analysis.
/// <para>
...
public sealed class MessageStateInspector
{
    ...
    /// lifecycle history to Ollama for a trace analysis summary.
        ...
        CancellationToken cancellationToken)
    {
        ...
        catch (Exception ex)
        {
            ...
            aiSummary = "⚠️ Ollama is unavailable. Trace analysis cannot be performed at this time. " +
...
/// event history and a trace analysis summary (or an explicit
...
public sealed class InspectionResult
{
    ...
    /// <summary>
    /// Trace analysis summary, or an explicit notification
    /// that Ollama is unavailable.
    /// </summary>
    public string Summary { get; init; } = string.Empty;

    /// <summary>
    /// <c>true</c> when the trace analysis was performed by Ollama;
